...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/userempresa.css">
        ...
        <section class="cards">
            ...
            <div class="card">
                <div class="card-box">
                    ...
                    <div class="txt-card">
                        ...
                        <p>Salário - A Combinar</p> <i class="bi bi-linkedin"></i>
            ...
            <div class="card">
                <div class="card-box">
                    ...
                    <div class="txt-card">
                        <h1>Mariana Texeira</h1>
                        <h3>Desenvolvedora Senior</h3>
                        <p>Salário - A Combinar</p> <i class="bi bi-linkedin"></i>
                        <i class="bi bi-github"></i>
                    </div><!--txt-card-->
                </div><!--card-box-->
