<?php
    ...
    $sql = "SELECT * FROM freelance ORDER BY usuario DESC";
  ...
  <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="index.html"><img src="" alt="Dev Hunt" /></a>
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tabela de cliente <code>.ativo</code>
                    </p>
                          ...
                          <?php
                              ...
                              {                            
                                ...
                                echo "<td>
                                      ...
                                      <a class='btn btn-outline-danger' href='delete.php?id=$user_data[id]'>
